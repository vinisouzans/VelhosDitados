...
function gerarFrase() {
    ...
    document.getElementById("frase-label").innerText = fraseAleatoria;
}

function enviarWhatsApp() {
    const frase = document.getElementById("frase-label").innerText;
    if (frase !== "Clique no botão para gerar uma frase") {
        const url = `https://api.whatsapp.com/send?text=${encodeURIComponent(frase)}`;
        window.open(url, '_blank');
    } else {
        alert("Por favor, gere uma frase antes de enviar.");
    }
}
